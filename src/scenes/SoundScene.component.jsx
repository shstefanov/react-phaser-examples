...
export default () => {
    ...
    return <PhaserScene
        ...
        audio = {{
            ...
            mysound2: "/audio/interface6.wav"                        // only url
        }}
    ...
    >
        ...
        <PhaserObject
            ...
            update={ ( scene, object ) => {
                if( object.keys.up.isDown)    { object.anims.play('ninja_m.walk_north', true); object.setVelocityY(-100); scene.sounds.mysound.play();}
                if( object.keys.down.isDown)  { object.anims.play('ninja_m.walk_south', true); object.setVelocityY( 100); scene.sounds.mysound.play();}
                if( object.keys.left.isDown)  { object.anims.play('ninja_m.walk_west',  true); object.setVelocityX(-100); scene.sounds.mysound.play();}
                if( object.keys.right.isDown) { object.anims.play('ninja_m.walk_east',  true); object.setVelocityX( 100); scene.sounds.mysound.play();}
            }}
